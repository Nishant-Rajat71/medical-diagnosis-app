...
from grad_cam import generate_grad_cam  # Make sure grad_cam.py is in the same folder

# Load the compressed model
@st.cache_resource
def load_trained_model():
    return load_model("compressed_model.h5")  # ✅ updated model name here

model = load_trained_model()

# Define class names in the order your model was trained
